...
func (x *Modsec) GetRulesPath() string {
	if x != nil {
		return x.RulesPath
	}
	return ""
...
var file_envoy_config_filter_http_modsec_v2_modsec_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_envoy_config_filter_http_modsec_v2_modsec_proto_goTypes = []interface{}{
	(*Modsec)(nil), // 0: envoy.config.filter.http.modsec.v2.modsec
}
...
func file_envoy_config_filter_http_modsec_v2_modsec_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_envoy_config_filter_http_modsec_v2_lua_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
